...
function guardarCompra($serie, $numero, $fecha_emision, $fecha_vencimiento,$operaciones_gravadas, $impueto_general_ventas, $importe_total, $moneda_id, $tipo_cambio_id,$tipo_comprobante_id, $tipo_pago_id, $proveedor_id){

    global $dbconn;
    $sql_insert = "insert into compras (serie, numero, fecha_emision, fecha_vencimiento, operaciones_gravadas) values ( :serie, :numero, :fecha_emision, :fecha_vencimiento, :operaciones_gravadas, :impuesto_general_ventas, :importe_total, :moneda_id, :tipo_cambio_id, :tipo_comprabante_id, :tipo_pago_id, proveedor_id)";
    $stmt = $dbconn->prepare($sql_insert);
    // insert a row
    $result = $stmt->execute(array(':serie'=>$serie, ':numero'=>$numero, ':fecha_emision'=>$fecha_emision, ':fecha_vencimiento'=>$fecha_vencimiento, ':operaciones_gravadas'=>$operaciones_gravadas, ':impuesto_general_ventas'=> $impuesto_general_ventas, 'importe_total' => $importe_total, 'moneda_id' => $moneda_id, 'tipo_cambio_id'=> $tipo_cambio_id, 'tipo_comprobante_id' => $tipo_comprobante_id, 'tipo_pago_id' => $tipo_pago_id, 'proveedor_id'=> $proveedor_id));
